...
class AutoridadesController extends Controller
{
    ...
    public function index()
    {
        ...
        $tableData = Autoridades::orderBy("id")->get();
    ...
    public function create()
    {
        ...
        return view("admin.autoridades.manage")->with(compact('admiko_data','docentes_all','cargo_all','unidad_all'));
    }
    ...
    public function edit($id)
    {
		...
		$unidad_all = Unidad::all()->sortBy("nombre")->pluck("nombre", "id");
        $data = $Autoridades;
        return view("admin.autoridades.manage")->with(compact('admiko_data', 'data','docentes_all','cargo_all','unidad_all'));
    }
