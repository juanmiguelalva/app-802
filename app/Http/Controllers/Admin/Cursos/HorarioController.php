...
class HorarioController extends Controller
{
    ...
    public function create()
    {
        ...
        $secciones_all = Secciones::where('ciclo', $curso->ciclo)->orderBy("nombre")->pluck("nombre", "id");
        return view("admin.cursos.horario.manage")->with(compact('admiko_data','docentes_all','dias_all','aulas_all','secciones_all',"curso"));
    }
    ...
    public function edit(Request $request,$admiko_cursos_id,$id)
    {
        ...
        $secciones_all = Secciones::where('ciclo', $curso->ciclo)->orderBy("nombre")->pluck("nombre", "id");
        $data = $Horario;
        return view("admin.cursos.horario.manage")->with(compact('admiko_data', 'data','docentes_all','dias_all','aulas_all','secciones_all',"curso","ciclo"));
    }
