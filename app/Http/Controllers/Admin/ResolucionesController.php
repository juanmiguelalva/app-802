...
class ResolucionesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tableData = Resoluciones::search($request->query("search"))->orderBy("id")->paginate($request->query("length")??array_key_first(config("admiko_config.length_menu_table_gallery")));
