...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.galeria.index") }}">Galería</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.galeria.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage galeria_manage admikoForm">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control form-control-textarea simple_text_editor" id="descripcin" name="descripcin"  placeholder="Descripción">{{{ old('descripcin', isset($data)?$data->descripcin : '') }}}</textarea>
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.galeria.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
