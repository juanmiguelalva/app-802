    ...
    <div class="card-body">
        <div class="card-body-items">
            ...
            @if(Gate::allows('resoluciones_allow'))
                <div class="row mt-3">
                    <div class="col-12">
                        <p class="mb-1">Subir documentos múltiples:</p>
                        <a href="#" class="btn btn-primary dropzoneShow mb-1" role="button"><i class="fas fa-file-upload fa-fw"></i> Subir</a>
                            ...
                            <div id="dropzone">
                                <form action="{{route('admin.resoluciones.admiko_many_files_store')}}" class="dropzone" id="my-awesome-dropzone">
                                    <div class="dz-message needsclick">
                                        <i class="fas fa-cloud-upload-alt fa-fw"></i><br><i>Suelte los archivos aquí o haga clic para cargar.</i>
                                    </div>
                                </form>
                            </div>
                            <p class="mb-0"> Puede seleccionar varios archivos manteniendo presionada la tecla "ctrl" en la PC.</p>
                        </div>
                    </div>
                    <script>
