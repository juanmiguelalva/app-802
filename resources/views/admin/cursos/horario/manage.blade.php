...
<div class="card formPage horario_manage admikoForm">
    ...
    <form method="POST" action="{{ $admiko_data['formAction'] }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <?php
                    if (count($secciones_all)) {
                ?>
                <div class=" col-lg-6">
                    <div class="form-group row">
                        <label for="seccin" class="col-md-2 col-lg-4 col-form-label">Sección*:</label>
                        <div class="col-md-10 col-lg-8">
                            <select class="form-select" id="seccin" name="seccin" required>
                                <option value="" disabled>{{trans("admiko.select")}}</option>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="dia" class="col-md-2 col-form-label">Dia:*</label>
                        <div class="col-md-10">
