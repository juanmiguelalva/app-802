...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.secciones.index") }}">Secciones</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.secciones.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage secciones_manage admikoForm">
            ...
            <div class="row">
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        <label for="nombre" class="col-md-2 col-lg-4 col-form-label">Nombre:*</label>
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.secciones.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
