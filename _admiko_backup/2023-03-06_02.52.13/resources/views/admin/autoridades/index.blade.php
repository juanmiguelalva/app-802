            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap">Apellidos y Nombres</th>
							<th scope="col" class="text-nowrap d-none d-sm-table-cell">Cargo</th>
							<th scope="col" class="text-nowrap d-none d-md-table-cell">Unidad</th>
                    ...
                    @foreach($tableData as $data)
                        <tr>
							...
							<td class="text-nowrap d-none d-sm-table-cell">{{$data->cargo_id->nombre??""}}</td>
							<td class="text-nowrap d-none d-md-table-cell">{{$data->unidad_id->nombre??""}}</td>
