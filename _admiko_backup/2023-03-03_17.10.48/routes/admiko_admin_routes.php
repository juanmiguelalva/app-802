...
/**Ciclos Seccion**/
Route::delete("ciclos/{admiko_ciclos_id}/seccion/destroy", [Ciclos\SeccionController::class,"destroy"])->name("seccion.delete");
Route::resource("ciclos/{admiko_ciclos_id}/seccion", Ciclos\SeccionController::class)->parameters(["seccion" => "seccion"]);
/**Condicion**/
