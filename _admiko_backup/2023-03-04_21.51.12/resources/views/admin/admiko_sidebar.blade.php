...
<li class="nav-item dropdown{{ $admiko_data['sideBarActiveFolder'] === "_sitio_web" ? " open" : "" }}">
	...
	@if(Gate::any(['galeria_allow', 'galeria_edit']))
		<li class="nav-item{{ $admiko_data['sideBarActive'] === "galeria" ? " active" : "" }}"><a class="nav-link dropdown-item" href="{{route('admin.galeria.index')}}"><i class="fas fa-file-alt fa-fw"></i>Galería</a></li>
	@endIf
