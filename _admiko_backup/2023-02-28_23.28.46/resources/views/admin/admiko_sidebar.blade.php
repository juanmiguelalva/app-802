...
<li class="nav-item dropdown{{ $admiko_data['sideBarActiveFolder'] === "_principal1" ? " open" : "" }}">
    <a href="#" class="nav-link dropdown-link"></i>PRINCIPAL</a>
...
@endIf
@if(Gate::any(['ambientes_allow','ambientes_edit','autoridades_allow','autoridades_edit','informacion_allow','informacion_edit','historia_allow','historia_edit','noticias_allow','noticias_edit','resoluciones_allow','resoluciones_edit','secigristas_allow','secigristas_edit']))
...
@endIf
@if(Gate::any(['tipo_profesor_allow','tipo_profesor_edit','condicion_allow','condicion_edit','especialidades_allow','especialidades_edit','grados_allow','grados_edit','aulas_allow','aulas_edit','unidad_allow','unidad_edit','cargo_allow','cargo_edit','tipo_publicacion_allow','tipo_publicacion_edit','ciclos_allow','ciclos_edit','dias_allow','dias_edit']))
<li class="nav-item dropdown{{ $admiko_data['sideBarActiveFolder'] === "_recursos" ? " open" : "" }}">
    <a href="#" class="nav-link dropdown-link"></i>RECURSOS</a>
