            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap d-none d-sm-table-cell">Nombre</th>
							<th scope="col" class="text-nowrap d-none d-md-table-cell">HT</th>
							<th scope="col" class="text-nowrap d-none d-lg-table-cell">HP</th>
                            <th scope="col" class="text-nowrap d-none d-lg-table-cell">TH</th>
                    ...
                    @foreach($tableData as $data)
                        <tr>
							<td class="w-5"><a href="{{route("admin.cursos.edit",[$data->id])}}">{{$data->id}}</a></td>
							<td class="text-nowrap">{{$data->codigo}}</td>
							<td class="text-nowrap d-none d-sm-table-cell">{{$data->nombre}}</td>
							<td class="text-nowrap d-none d-md-table-cell">{{$data->horas_t}}</td>
							<td class="text-nowrap d-none d-lg-table-cell">{{$data->horas_p}}</td>
                            <td class="text-nowrap d-none d-lg-table-cell">{{$data->horas_p+$data->horas_t}}</td>
