            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap d-none d-sm-table-cell">Unidad</th>
							<th scope="col" class="text-nowrap d-none d-md-table-cell">Docente</th>
                    ...
                    @foreach($tableData as $data)
                        <tr>
							...
							<td class="text-nowrap">{{$data->cargo_id->nombre??""}}</td>
							<td class="text-nowrap d-none d-sm-table-cell">{{$data->unidad_id->nombre??""}}</td>
							<td class="text-nowrap d-none d-md-table-cell">{{$data->docente_id->apellidos??""}}</td>
