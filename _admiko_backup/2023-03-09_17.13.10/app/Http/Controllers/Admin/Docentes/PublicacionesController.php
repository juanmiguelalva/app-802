...
class PublicacionesController extends Controller
{
    ...
    public function create()
    {
		...
		$tipo_publicacion_all = TipoPublicacion::all()->sortBy("nombre")->pluck("nombre", "id");
        return view("admin.docentes.publicaciones.manage")->with(compact('admiko_data','tipo_publicacion_all'));
    }
    ...
    public function edit($admiko_docentes_id,$id)
    {
		...
		$tipo_publicacion_all = TipoPublicacion::all()->sortBy("nombre")->pluck("nombre", "id");
        $data = $Publicaciones;
        return view("admin.docentes.publicaciones.manage")->with(compact('admiko_data', 'data','tipo_publicacion_all'));
    }
