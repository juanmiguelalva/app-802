...
class DocentesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tableData = Docentes::search($request->query("search"))->orderBy("id")->paginate($request->query("length")??array_key_first(config("admiko_config.length_menu_table")));
    ...
    public function create()
    {
		...
		$condicion_all = Condicion::all()->sortByDesc("nombre")->pluck("nombre", "id");
        ...
        return view("admin.docentes.manage")->with(compact('admiko_data','tipo_profesor_all','condicion_all','especialidades_all','grados_all'));
    }
    ...
    public function edit($id)
    {
		...
		$grados_all = Grados::all()->sortBy("abreviatura")->pluck("abreviatura", "id");
        $data = $Docentes;
        return view("admin.docentes.manage")->with(compact('admiko_data', 'data','tipo_profesor_all','condicion_all','especialidades_all','grados_all'));
    }
