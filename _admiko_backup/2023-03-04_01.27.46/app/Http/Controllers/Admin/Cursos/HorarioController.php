...
class HorarioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $seccion_all = Seccion::where('admiko_ciclos_id', $curso->ciclo)->orderBy("nombre")->pluck("nombre", "id");
        ...
        return view("admin.cursos.horario.index")->with(compact('admiko_data', "tableData","seccion_all","curso"));
    }
    ...
    public function create()
    {
		...
		$seccion_all = Seccion::where('admiko_ciclos_id', $curso->ciclo)->orderBy("nombre")->pluck("nombre", "id");
        return view("admin.cursos.horario.manage")->with(compact('admiko_data','dias_all','aulas_all','docentes_all','seccion_all'));
    }
    ...
    public function edit($admiko_cursos_id,$id)
    {
		...
		$seccion_all = Seccion::where('admiko_ciclos_id', $curso->ciclo)->orderBy("nombre")->pluck("nombre", "id");
        $data = $Horario;
        return view("admin.cursos.horario.manage")->with(compact('admiko_data', 'data','dias_all','aulas_all','docentes_all','seccion_all'));
    }
