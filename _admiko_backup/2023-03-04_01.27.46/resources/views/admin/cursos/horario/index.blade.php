            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap d-none d-lg-table-cell">Aula</th>
                            @if(count($seccion_all) > 0)
                    ...
                    @foreach($tableData as $data)
                        <tr>
							...
							<td class="text-nowrap">{{$data->docente_id->apellidos??""}}</td>
							...
							<td class="text-nowrap d-none d-lg-table-cell">{{$data->aula_id->codigo??""}}</td>
                            <?php
                                if(count($seccion_all)>0){
                            ?>
							<td class="text-nowrap d-none d-lg-table-cell">{{$data->seccin_id->nombre??""}}</td><?php } ?>
