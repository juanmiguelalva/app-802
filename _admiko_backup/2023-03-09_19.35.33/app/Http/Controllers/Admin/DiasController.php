...
class DiasController extends Controller
{
    ...
    public function create()
    {
		...
		$p_all = Dias::P_CONS;
        return view("admin.dias.manage")->with(compact('admiko_data','p_all'));
    }
    ...
    public function store(DiasRequest $request)
    {
        ...
        $Dias->p_many()->sync($request->input("p", []));
        return redirect(route("admin.dias.index"));
    }
    ...
    public function edit($id)
    {
		...
		$p_all = Dias::P_CONS;
        $data = $Dias;
        return view("admin.dias.manage")->with(compact('admiko_data', 'data','p_all'));
    }
