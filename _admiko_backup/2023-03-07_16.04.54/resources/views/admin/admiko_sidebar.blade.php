...
<li class="nav-item dropdown{{ $admiko_data['sideBarActiveFolder'] === "_recursos" ? " open" : "" }}">
	...
	@if(Gate::any(['distribucion_de_aulas_allow', 'distribucion_de_aulas_edit']))
		<li class="nav-item{{ $admiko_data['sideBarActive'] === "distribucion_de_aulas" ? " active" : "" }}"><a class="nav-link dropdown-item" href="{{route('admin.distribucion_de_aulas.index')}}"><i class="fas fa-file-alt fa-fw"></i>Distribucion de Aulas</a></li>
	@endIf
