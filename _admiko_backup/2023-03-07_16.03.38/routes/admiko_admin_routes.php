...
/**DistribucionDeAulas**/
Route::delete("distribucion_de_aulas/destroy/{id?}", [DistribucionDeAulasController::class,"destroy"])->name("distribucion_de_aulas.delete");
Route::get("distribucion_de_aulas/{id}/create", [DistribucionDeAulasController::class,"create"])->name("distribucion_de_aulas.create");
Route::post("distribucion_de_aulas/{id}/store", [DistribucionDeAulasController::class,"store"])->name("distribucion_de_aulas.store");
Route::get("distribucion_de_aulas/{id}/edit", [DistribucionDeAulasController::class,"edit"])->name("distribucion_de_aulas.edit");
Route::put("distribucion_de_aulas/{id}/update", [DistribucionDeAulasController::class,"update"])->name("distribucion_de_aulas.update");
Route::get("distribucion_de_aulas/{id?}", [DistribucionDeAulasController::class,"index"])->name("distribucion_de_aulas.index");
/**Especialidades**/
