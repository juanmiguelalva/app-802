...
Route::delete("horarios/destroy", [HorarioController::class,"destroy"])->name("horarios.delete");
Route::resource("horarios", HorarioController::class)->parameters(["horarios" => "horarios"]);
...
/**DistribucionDeAulas**/
Route::delete("distribucion_de_aulas/destroy", [DistribucionDeAulasController::class,"destroy"])->name("distribucion_de_aulas.delete");
Route::resource("distribucion_de_aulas", DistribucionDeAulasController::class)->parameters(["distribucion_de_aulas" => "distribucion_de_aulas"]);
/**Especialidades**/
